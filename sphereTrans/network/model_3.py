...
class SphereTrans(nn.Module):
    def __init__(self, img_size=256, in_chans=3,
        ...
        self.output_proj = OutputProj(in_channel=embed_dim * 2, out_channel=num_classes, kernel_size=3, stride=1,          # 输出层
    ...
    def forward(self, x):
        ...
        # y = self.upsample_00(y)
        # y = self.upsample_01(y)
        # y = self.upsample_02(y)
        # y = self.upsample_03(y)
        #print(y.shape)
