...
# model settings
parser.add_argument("--model_name", type=str, default="newest(stage=4, cosLR)", help="folder to save the model in") # v4: sphereVit+attention v5:only attention
...
parser.add_argument("--vis_dir", default='./results', help="path to save visualization results")
